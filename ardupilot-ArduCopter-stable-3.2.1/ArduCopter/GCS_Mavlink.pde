...
static void NOINLINE send_ir_data(mavlink_channel_t chan)
{
    ircam.read();
    mavlink_msg_ir_data_send(
        chan,
        ircam.get_landpoint_midpoint_distance_x(),
        ircam.get_landpoint_midpoint_distance_y()
    );
}
...
bool GCS_MAVLINK::try_send_message(enum ap_message id)
{
    ...
    case MSG_IR_DATA:                       //!!! CODE HERE !!!
        CHECK_PAYLOAD_SIZE(IR_DATA);
        send_ir_data(chan);
        break;
