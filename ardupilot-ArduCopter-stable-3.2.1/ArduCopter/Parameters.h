...
public:
    ...
    enum {
        ...
        //120: IR_CAM                                                         !!!CODE HERE
        
        k_param_ircam_enabled = 120,
        ...
        k_param_pid_ircam_roll,  
        k_param_pid_ircam_pitch,    //246
        k_param_pid_ircam_yaw,      //247
        k_param_pid_ircam_alt,      //248
    ...
    AP_Int8         ircam_enabled;              // !!!CODE HERE!!!
    ...
    AC_PID                  pid_ircam_roll;
    AC_PID                  pid_ircam_pitch;
    AC_PID                  pid_ircam_yaw;
    AC_PID                  pid_ircam_alt;
    ...
    Parameters() :
        ...
        pid_ircam_roll          (IRCAM_ROLL_P,          IRCAM_ROLL_I,           IRCAM_ROLL_D,           IRCAM_IMAX),
        pid_ircam_pitch         (IRCAM_PITCH_P,         IRCAM_PITCH_I,          IRCAM_PITCH_D,          IRCAM_IMAX),
        pid_ircam_yaw           (IRCAM_YAW_P,           IRCAM_YAW_I,            IRCAM_YAW_D,            IRCAM_IMAX),
        pid_ircam_alt           (IRCAM_ALT_P,           IRCAM_ALT_I,            IRCAM_ALT_D,            IRCAM_IMAX),
