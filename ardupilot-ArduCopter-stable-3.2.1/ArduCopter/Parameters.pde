...
const AP_Param::Info var_info[] PROGMEM = {
    ...
    // @Param: IR_ENABLE
    // @DisplayName: IR Camera enable/disable
    // @Description: Setting this to Enabled(1) will enable IR Camera. Setting this to Disabled(0) will disable IR Camera
    // @Values: 0:Disabled,1:Enabled
    // @User: Standard
    GSCALAR(ircam_enabled,           "IR_ENABLE",  IR_CAM_MODE),
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,10:OF_Loiter,11:Drift,13:Sport,16:PosHold,17:IRCam
    // @User: Standard
    ...
    // @Description: Bitmask which holds which flight modes use simple heading mode (eg bit 0 = 1 means Flight Mode 0 uses simple mode),17:IRCam
    // @User: Advanced
    ...
    // @Param: IR_RLL_P
    // @DisplayName: IR Camera based loiter controller roll axis P gain
    // @Description: IR Camera based loiter controller roll axis P gain.  Converts the position error from the target point to a roll angle
    // @Range: 2.000 3.000
    // @User: Standard

    // @Param: IR_RLL_I
    // @DisplayName: IR Camera based loiter controller roll axis I gain
    // @Description: IR Camera based loiter controller roll axis I gain.  Corrects long-term position error by more persistently rolling left or right
    // @Range: 0.250 0.750
    // @User: Standard

    // @Param: IR_RLL_IMAX
    // @DisplayName: IR Camera based loiter controller roll axis I gain maximum
    // @Description: IR Camera based loiter controller roll axis I gain maximum.  Constrains the maximum roll angle that the I term will generate
    // @Range: 0 4500
    // @Units: Centi-Degrees
    // @User: Standard

    // @Param: IR_RLL_D
    // @DisplayName: IR Camera based loiter controller roll axis D gain
    // @Description: IR Camera based loiter controller roll axis D gain.  Compensates for short-term change in speed in the roll direction
    // @Range: 0.100 0.140
    // @User: Standard
    GGROUP(pid_ircam_roll,  "IR_RLL_",   AC_PID),
    
    // @Param: IR_PIT_P
    // @DisplayName: IR Camera based loiter controller pitch axis P gain
    // @Description: IR Camera based loiter controller pitch axis P gain.  Converts the position error from the target point to a pitch angle
    // @Range: 2.000 3.000
    // @User: Standard

    // @Param: IR_PIT_I
    // @DisplayName: IR Camera based loiter controller pitch axis I gain
    // @Description: IR Camera based loiter controller pitch axis I gain.  Corrects long-term position error by more persistently pitching left or right
    // @Range: 0.250 0.750
    // @User: Standard

    // @Param: IR_PIT_IMAX
    // @DisplayName: IR Camera based loiter controller pitch axis I gain maximum
    // @Description: IR Camera based loiter controller pitch axis I gain maximum.  Constrains the maximum pitch angle that the I term will generate
    // @Range: 0 4500
    // @Units: Centi-Degrees
    // @User: Standard

    // @Param: IR_PIT_D
    // @DisplayName: IR Camera based loiter controller pitch axis D gain
    // @Description: IR Camera based loiter controller pitch axis D gain.  Compensates for short-term change in speed in the pitch direction
    // @Range: 0.100 0.140
    // @User: Standard
    GGROUP(pid_ircam_pitch, "IR_PIT_",   AC_PID),
    
    // @Param: IR_YAW_P
    // @DisplayName: IR Camera based loiter controller yaw axis P gain
    // @Description: IR Camera based loiter controller yaw axis P gain.  Converts the position error from the target point to a roll angle
    // @Range: 2.000 3.000
    // @User: Standard

    // @Param: IR_YAW_I
    // @DisplayName: IR Camera based loiter controller yaw axis I gain
    // @Description: IR Camera based loiter controller yaw axis I gain.  Corrects long-term position error by more persistently rolling left or right
    // @Range: 0.250 0.750
    // @User: Standard

    // @Param: IR_YAW_IMAX
    // @DisplayName: IR Camera based loiter controller yaw axis I gain maximum
    // @Description: IR Camera based loiter controller yaw axis I gain maximum.  Constrains the maximum roll angle that the I term will generate
    // @Range: 0 4500
    // @Units: Centi-Degrees
    // @User: Standard

    // @Param: IR_YAW_D
    // @DisplayName: IR Camera based loiter controller yaw axis D gain
    // @Description: IR Camera based loiter controller yaw axis D gain.  Compensates for short-term change in speed in the roll direction
    // @Range: 0.100 0.140
    // @User: Standard
    GGROUP(pid_ircam_yaw,  "IR_YAW_",   AC_PID),
    
    // @Param: IR_ALT_P
    // @DisplayName: IR Camera based loiter controller alt axis P gain
    // @Description: IR Camera based loiter controller alt axis P gain.  Converts the position error from the target point to a roll angle
    // @Range: 2.000 3.000
    // @User: Standard

    // @Param: IR_ALT_I
    // @DisplayName: IR Camera based loiter controller alt axis I gain
    // @Description: IR Camera based loiter controller alt axis I gain.  Corrects long-term position error by more persistently rolling left or right
    // @Range: 0.250 0.750
    // @User: Standard

    // @Param: IR_ALT_IMAX
    // @DisplayName: IR Camera based loiter controller alt axis I gain maximum
    // @Description: IR Camera based loiter controller alt axis I gain maximum.  Constrains the maximum roll angle that the I term will generate
    // @Range: 0 4500
    // @Units: Centi-Degrees
    // @User: Standard

    // @Param: IR_ALT_D
    // @DisplayName: IR Camera based loiter controller alt axis D gain
    // @Description: IR Camera based loiter controller alt axis D gain.  Compensates for short-term change in speed in the roll direction
    // @Range: 0.100 0.140
    // @User: Standard
    GGROUP(pid_ircam_alt,  "IR_ALT_",   AC_PID),
