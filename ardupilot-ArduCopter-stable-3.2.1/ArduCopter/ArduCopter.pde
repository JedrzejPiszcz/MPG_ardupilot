...
////////////////////////////////////////////////////////////////////////////////
//IRCAMERA
// The Commanded Roll from the autopilot based on IR Camera sensor.
static int32_t ir_roll=0;
// The Commanded pitch from the autopilot based on IR Camera sensor.
static int32_t ir_pitch=0;
// The Commanded yaw from the autopilot based on compass for IRCamera sensor.
static float target_ir_yaw = 0.0;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 #if IR_CAMERA == ENABLED
static IRCamera ircam(ahrs, barometer, inertial_nav);
 #endif
...
static void ircam_update(void)
{
    static uint8_t ir_log_counter = 0;
    if(control_mode==IRCAM)
    {
        if(!ircam.read()) //read fails only if camera hardware failed - meaning i2c transmission failed
            {
                ircam.init(3);
            };
