...
// Write IRCam
static void Log_Write_IRCam()
{
    struct log_IRCam pkt = {
        LOG_PACKET_HEADER_INIT(LOG_IRCAM_MSG),
        C_loc                : ircam.get_lock_check(),
        X_err                : ircam.get_compensated_error_x(),
        Y_err                : ircam.get_compensated_error_y(),
        A_err                : ircam.get_cm_alt(),
        Ir_r_l               : ir_roll,
        Ir_p_l               : ir_pitch,
        Ir_y_l               : ir_yaw,
        Ir_a_l               : ir_alt,
...
static const struct LogStructure log_structure[] PROGMEM = {
    ...
    { LOG_IRCAM_MSG, sizeof(log_IRCam),      
      "IR",   "Bfffeeff",   "C_loc,X_err,Y_err,A_err,Ir_r_l,Ir_p_l,Ir_y_l,Ir_a_l" },
...
static void Log_Write_Error(uint8_t sub_system, uint8_t error_code) {}
static void Log_Write_Baro(void) {}
static void Log_Write_IRCam() {} //IRCAM LOGGING ADDED
